			...
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					...
					<nav id="menu" class="pull-right">
						<ul>
							<li><a href="goods.jsp">Woman</a>
								<ul>
									<li><a href="goods.jsp">Lacinia nibh</a></li>
									<li><a href="goods.jsp">Eget molestie</a></li>
									<li><a href="goods.jsp">Varius purus</a></li>
								</ul>
							</li>															
							<li><a href="goods.jsp">Man</a></li>
							<li><a href="goods.jsp">Sport</a>
								<ul>									
									<li><a href="goods.jsp">Gifts and Tech</a></li>
									<li><a href="goods.jsp">Ties and Hats</a></li>
									<li><a href="goods.jsp">Cold Weather</a></li>
								</ul>
							</li>							
							<li><a href="goods.jsp">Hangbag</a></li>
							<li><a href="goods.jsp">Best Seller</a></li>
							<li><a href="goods.jsp">Top Seller</a></li>
						</ul>
					</nav>
				</div>
			</section>				
